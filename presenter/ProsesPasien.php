...
class ProsesPasien implements KontrakPresenter
{
    ...
    {
        return $this->tabelpasien->createPasien($nik, $nama, $tempat, $tl, $gender, $email, $telp);
    }
    function getPasienById($id)
    {
        return $this->tabelpasien->getPasienById($id);
    }
    
    function updatePasien($id, $nik, $nama, $tempat, $tl, $gender, $email, $telp)
    {
        return $this->tabelpasien->updatePasien($id, $nik, $nama, $tempat, $tl, $gender, $email, $telp);
    }
    function deletePasien($id)
    {
        return $this->tabelpasien->deletePasien($id);
    }
	function getId($i)
	{
